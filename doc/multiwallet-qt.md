...
In order to support loading of multiple wallets in expi-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is expi.cpp.
...
Changes to expi.cpp
----------------------
expi.cpp is the entry point into expi-qt, and as such, will require some minor modifications to provide hooks for
