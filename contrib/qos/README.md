...
This means one can have an always-on expid instance running, and another local expid/expi-qt instance which connects to this node and receives blocks from it.
