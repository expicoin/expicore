...
RESOURCES += src/qt/expi.qrc src/qt/expi_locale.qrc

TRANSLATIONS += src/qt/locale/expi_bg.ts \
                src/qt/locale/expi_de.ts \
                src/qt/locale/expi_en.ts \
                src/qt/locale/expi_es.ts \
                src/qt/locale/expi_fi.ts \
                src/qt/locale/expi_fr.ts \
                src/qt/locale/expi_it.ts \
                src/qt/locale/expi_ja.ts \
                src/qt/locale/expi_pl.ts \
                src/qt/locale/expi_pt.ts \
                src/qt/locale/expi_ru.ts \
                src/qt/locale/expi_sk.ts \
                src/qt/locale/expi_sv.ts \
                src/qt/locale/expi_vi.ts \
                src/qt/locale/expi_zh_CN.ts \
                src/qt/locale/expi_zh_TW.ts
