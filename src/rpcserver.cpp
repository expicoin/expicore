...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EXPi features */
        {"expi", "masternode", &masternode, true, true, false},
        {"expi", "listmasternodes", &listmasternodes, true, true, false},
        {"expi", "getmasternodecount", &getmasternodecount, true, true, false},
        {"expi", "masternodeconnect", &masternodeconnect, true, true, false},
        {"expi", "masternodecurrent", &masternodecurrent, true, true, false},
        {"expi", "masternodedebug", &masternodedebug, true, true, false},
        {"expi", "startmasternode", &startmasternode, true, true, false},
        {"expi", "createmasternodekey", &createmasternodekey, true, true, false},
        {"expi", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"expi", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"expi", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"expi", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"expi", "getmasternodescores", &getmasternodescores, true, true, false},
        {"expi", "mnbudget", &mnbudget, true, true, false},
        {"expi", "preparebudget", &preparebudget, true, true, false},
        {"expi", "submitbudget", &submitbudget, true, true, false},
        {"expi", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"expi", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"expi", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"expi", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"expi", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"expi", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"expi", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"expi", "checkbudgets", &checkbudgets, true, true, false},
        {"expi", "mnsync", &mnsync, true, true, false},
        {"expi", "spork", &spork, true, true, false},
        {"expi", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"expi", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use expid, or the -server option to expi-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> expi-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:14555/\n";
}
