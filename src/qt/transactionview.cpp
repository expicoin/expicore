                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received EXPi from zEXPi"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zEXPi"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEXPi));
