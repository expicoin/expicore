                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EXPi Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EXPi address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and expi: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zEXPi"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EXPi Core"), this);
    aboutAction->setStatusTip(tr("Show information about EXPi Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EXPi"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EXPi addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EXPi addresses"));
	...
	*/
    ...
    openAction->setStatusTip(tr("Open a EXPi: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EXPi Core help message to get a list with possible EXPi command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EXPi Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EXPi network", "", count));
}
...
{
    QString strTitle = tr("EXPi Core"); // default title
