...
public:
    ...
    void setZEXPiControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzEXPi_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzEXPi_clicked();
    void on_pushButtonZEXPiControl_clicked();
