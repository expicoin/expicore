...
public:
    CMainParams()
    {
        ...
        bnProofOfWorkLimit = ~uint256(0) >> 20; // EXPi starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // EXPi: 1 day  
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Bitcoin is the first peer-to-peer digital currency";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1557504000;	   // Friday, May 10, 2019 12:00:00 PM
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 0xfa19;
        
        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("000095e7f7874e05ce05f5b2f717b2d54df3ad1e37926bde873a8024d83fc9db"));
        assert(genesis.hashMerkleRoot == uint256("24185e05a6fa4b851941935a3bfd82528c01c959a160cf9804482943bea65a55"));

		
        vSeeds.push_back(CDNSSeedData("seed1", "80.211.132.135"));
        vSeeds.push_back(CDNSSeedData("seed2", "80.211.239.181"));
        vSeeds.push_back(CDNSSeedData("seed3", "80.211.115.94"));
        vSeeds.push_back(CDNSSeedData("seed4", "212.237.28.45"));
        vSeeds.push_back(CDNSSeedData("seed5", "80.211.87.43"));
        vSeeds.push_back(CDNSSeedData("seed6", "80.211.47.119"));
        ...
        strSporkKey = "04e3833f2eea87d464b03bc330db3ea77044dfd82a1cec01707fef3dc17e9a7a92582b9580f27a15488958c21316a6e65882c5e215ef592ec5a376ab904b259ed6";
        strObfuscationPoolDummyAddress = "ERVPKiB3yCLG8J2LQW1emA1FVAx6sTCs9W";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // EXPi: 1 day
        nTargetSpacing = 60;  // EXPi: 1 minute
        //nTargetSpacing = 20;  // EXPi: 20 seconds FAST TRACK TEST!!!
        nLastPOWBlock = 800;
        nMaturity = 24;
        ...
        strSporkKey = "0478adfc790fc6526f3ec920b801cd2eef437ee2673cef5442a6228549c48df2d4d87b1dc5aff8b4ed511710a02a9be24aceee0881b52f65c6771838bb2b40e49c";
        strObfuscationPoolDummyAddress = "e7pHyjE84Ujv2Kc74XPn8vZvLnUA5RAYXj";
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // EXPi: 1 day
        nTargetSpacing = 90;        // EXPi: 1.5 minutes
